...
# 연결성, 메세지 송수신
# 클래스 3개 생성 -> 2개는 연결성, 송수신 | % 미정 %  1개는 다중상속

class ClientConnectionManagement(Thread):  # Class for Checking new connections
    ...
    def __check_new_connection(self):
        """
    ...
    def __disconnection(self, connection_socket_object):
        """
